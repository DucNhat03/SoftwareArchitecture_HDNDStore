            ...
            <CardContent>
              <Grid container spacing={2} alignItems="center">
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Quản lý thông tin và kho hàng của sản phẩm giày nam
                  </Typography>
                </Grid>
            ...
            <Grid item xs={12} md={6}>
              ...
              <FormControl fullWidth variant="outlined" sx={{ mb: 2 }}>
                ...
                >
                  ...
                  <MenuItem value="Giày thể thao">Giày thể thao</MenuItem>
                  <MenuItem value="Giày lười">Giày lười</MenuItem>
                  <MenuItem value="Dép nam">Dép nam</MenuItem>
                  <MenuItem value="Boot nam">Boot nam</MenuItem>
                </Select>
              </FormControl>
